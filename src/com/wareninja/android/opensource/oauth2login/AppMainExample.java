...
import com.wareninja.android.opensource.oauth2login.vpsa.VPSAOAuthDialog;
...
public class AppMainExample extends Activity {
    ...
    public void onClick_vpsaLogin(View v)
    {
		...
		new VPSAOAuthDialog(mContext, authRequestRedirect
			...
			public void onComplete(Bundle values) {
				...
				try{
					...
					params.put("app_id", AppContext.FSQ_APP_KEY);
					params.put("app_secret", AppContext.FSQ_APP_SECRET);
					...
					tokenResponse = webService.webInvokeWithJson(AppContext.FSQ_APP_TOKEN_URL, webService.getJsonFromParams(params));
					
					texto.setText(tokenResponse);
